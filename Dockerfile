...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/benjwadams/ckanext-spatial.git@pyscw_add_organization#egg=ckanext-spatial
...
COPY ./contrib/config/pycsw/mappings.py $CKAN_CONFIG/mappings.py
